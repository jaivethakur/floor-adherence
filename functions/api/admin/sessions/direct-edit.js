...
export async function onRequestPost(context) {
  ...
  try {
    ...
    ).bind(logId, sessionId, admin.id, fieldChanged, breakId || null, oldValue, newValue, reason || 'Direct Admin Update', admin.id).run();

    return jsonResponse({
      message: 'Session updated and logged successfully',
      sessionId,
      fieldChanged,
      oldValue,
      newValue,
